exports.handler = async function(event, context) {
  ...
  try {
    const { email, name, code, expires_at, days } = JSON.parse(event.body);
    ...
    const daysLabel = days ? `${days} day${days > 1 ? 's' : ''}` : '48 hours';
          ...
          <div style="font-family: Arial, sans-serif; max-width: 520px; margin: 0 auto; background: #0d1117; color: #e6edf3; border-radius: 12px; overflow: hidden; border: 1px solid #2a3444;">
            ...
            <div style="padding: 32px;">
              ...
              <p style="font-size: 14px; color: #8b949e; margin-bottom: 28px; line-height: 1.6;">
                Your request to access ProviderPulse has been approved. Use the code below to sign in.
                Your access is valid for <strong style="color:#e6edf3;">${daysLabel}</strong>.
              </p>
              ...
              <p style="font-size: 12px; color: #484f58; line-height: 1.6;">
                This code is for your use only. Do not share it with others.
    ...
    if (!res.ok) {
      return { statusCode: 500, body: `Email failed: ${responseText}` };
    }
